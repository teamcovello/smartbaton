...
public class FitbitApiEntityCacheMaplmpl implements FitbitAPIEntityCache {

    private static final Log log = LogFactory.getLog(FitbitApiEntityCacheMaplmpl.class);
